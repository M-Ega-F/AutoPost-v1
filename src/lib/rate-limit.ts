...
export const RATE_LIMITS = {
  ...
  oauthStart: { limit: 20, windowMs: 5 * 60_000 },
  oauthCallback: { limit: 20, windowMs: 5 * 60_000 },
  mediaUpload: { limit: 30, windowMs: 60_000 },
  mediaUrl: { limit: 30, windowMs: 60_000 },
  reuse: { limit: 60, windowMs: 60_000 },
  saveSettings: { limit: 30, windowMs: 60_000 },
  analyticsRefresh: { limit: 20, windowMs: 60_000 },
  invitationCreate: { limit: 20, windowMs: 60 * 60_000 },
  invitationResend: { limit: 30, windowMs: 60 * 60_000 },
  invitationAccept: { limit: 20, windowMs: 60 * 60_000 },
  workspaceCreate: { limit: 10, windowMs: 60 * 60_000 },
  workspaceUpdate: { limit: 30, windowMs: 60 * 60_000 },
  workspaceTransfer: { limit: 5, windowMs: 60 * 60_000 },
  workspaceLeave: { limit: 10, windowMs: 60 * 60_000 },
  ...
  webhookCreate: { limit: 10, windowMs: 60_000 },
  webhookUpdate: { limit: 30, windowMs: 60_000 },
